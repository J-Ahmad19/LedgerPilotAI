    ...
    <div className="min-h-screen bg-charm-surface flex flex-col justify-center py-12 sm:px-6 lg:px-8 text-charm-body relative overflow-hidden">
      ...
      <div className="sm:mx-auto sm:w-full sm:max-w-md relative z-10">
        ...
        <p className="mt-2 text-center text-sm text-charm-muted">
          Get started with your LedgerPilotAI workspace.
        </p>
      </div>
      ...
      <div className="mt-8 sm:mx-auto sm:w-full sm:max-w-md relative z-10">
        <div className="charm-panel py-8 px-4 sm:px-10">
          <form className="space-y-6" onSubmit={handleSubmit}>
            <div>
              <label htmlFor="name" className="block text-sm font-medium text-charm-heading">
                Full Name
              </label>
              <div className="mt-1">
                <input
          ...
          <div className="mt-6 text-center text-sm">
             <span className="text-charm-muted">Already have an account?</span>{" "}
             <Link to="/login" className="font-medium text-charm-brand hover:opacity-80 transition-opacity">
               Log in
             </Link>
          </div>
        </div>
